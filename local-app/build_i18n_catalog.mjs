...
const operationalSource = [
  ...
  "This certifies that",
  "has completed the following site induction:",
  "Not specified",
  "Completed",
  "Valid until",
  "Certificate",
  "Verify this certificate using the QR code or address below:",
  "Generated by",
  "Status must be checked online.",
  "Controlled local form submission",
  "Submitted at",
  "Captured signature",
  "Answer",
  "Attachments",
...
const isUiCandidate = value => {
  ...
  if (/(?:=>|\?\.|\?\?|===|!==|&&|\|\||\.(?:join|map|filter|slice|split|pop|localeCompare)\(|\b(?:window|document|Object|String|JSON|Math|Array)\.|querySelector|addEventListener|dataset\.)/.test(text)) return false;
